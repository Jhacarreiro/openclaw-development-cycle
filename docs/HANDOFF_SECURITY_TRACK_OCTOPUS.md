...
Update `README.md`, `docs/architecture.md`, `docs/adapters.md`, `docs/configuration.md`, `CHANGELOG.md`, then any private operator state documentation only after the feature is live.
