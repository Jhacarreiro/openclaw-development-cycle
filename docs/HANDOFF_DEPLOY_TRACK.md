...
Date: 2026-09-02  
Repository: `openclaw-development-cycle`
...
Protected-path approval remains an external human policy. The plugin may persist supplied evidence but must not claim it is human-approved unless the caller supplies it as such.
...
Update `README.md`, `docs/architecture.md`, `docs/adapters.md`, `docs/configuration.md`, `CHANGELOG.md`, then any private operator documentation only after the feature is live.
